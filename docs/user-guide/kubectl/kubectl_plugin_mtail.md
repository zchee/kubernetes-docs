## kubectl plugin mtail

Tail logs from multiple pods at once

### Synopsis

Streams logs from multiple pods at once, by selector. Uses "kubectl logs --tail=10 --follow" Example: $ kubectl plugin mtail app=web,tier=frontend

```
kubectl plugin mtail [flags]
```

### Options

```
  -h, --help   help for mtail
```
