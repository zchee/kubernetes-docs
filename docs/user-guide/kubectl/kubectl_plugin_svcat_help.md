## kubectl plugin svcat help

Help about any command

### Synopsis

Help provides help for any command in the application. Simply type svcat help [path to command] for full details.

```
kubectl plugin svcat help [flags]
```
