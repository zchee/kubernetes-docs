## kubectl plugin svcat describe plan
...
```
kubectl plugin svcat describe plan [flags]
```
...
```
  -h, --help                  help for plan
      --show-schemas string   Whether or not to show instance and binding parameter schemas
  -u, --uuid string           Whether or not to get the class by UUID (the default is by name)
```
