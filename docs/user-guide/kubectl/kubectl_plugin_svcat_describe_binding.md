## kubectl plugin svcat describe binding
...
```
kubectl plugin svcat describe binding [flags]
```
...
```
  -h, --help                  help for binding
      --show-secrets string   Output the decoded secret values. By default only the length of the secret is displayed
```
