## kubectl plugin svcat sync

Syncs service catalog for a service broker
...
```
kubectl plugin svcat sync [flags]
```
...
* [kubectl plugin svcat sync broker](kubectl_plugin_svcat_sync_broker.md)	 - Syncs service catalog for a service broker
