...
Output the CA certificate of the current context in PEM format

### Synopsis

Outputs the CA certificate of the current context in PEM format.

```
kubectl plugin ca-cert [flags]
```
